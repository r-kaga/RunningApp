...
//        self.view.addSubview(button)
    ...
    private func setupScrollView() {
        scrollView = UIScrollView(frame: CGRect(x: 0, y: AppSize.statusBarAndNavigationBarHeight + 50, width: AppSize.width, height: AppSize.height))
...
//        barChartView.xAxis.enabled = false
        ...
        scrollView.contentSize.height += barChartView.frame.height / 2 + 40
